...
class LTCC(object):
    ...
    def _process_dir_train(self, dir_path):
        ...
        for img_path in img_paths:
            caption = self.text[img_path]
            person_caption = self.person_text[img_path]
            ...
            dataset.append((img_path, pid, camid, clothes_id,caption,person_caption))
    ...
    def _process_dir_test(self, query_path, gallery_path):
        ...
        for img_path in query_img_paths:
            ...
            query_dataset.append((img_path, pid, camid, clothes_id,caption,person_caption))
        ...
        for img_path in gallery_img_paths:
            ...
            gallery_dataset.append((img_path, pid, camid, clothes_id,caption,person_caption))
...
if __name__ == '__main__':
    ltcc=LTCC(root='/the/path/to/your/data')